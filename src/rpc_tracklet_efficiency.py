...
def main():
    ...
    ap.add_argument("--regime", default="normal", choices=["normal", "beam"],
                    help="Running regime label propagated by the HV pipeline. Currently used for bookkeeping and future regime-aware tuning.")
    ...
    ap.add_argument("--theta-max-deg", type=float, default=None,
                    help="Optional maximum track inclination angle in degrees for reference-track eligibility. Useful mainly in beam mode; leave unset to disable.")
